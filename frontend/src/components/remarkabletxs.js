...
//           "https://blockstream.info/api/block/0000000000000000000c53d02fb8b7a2b9ac2a86a090a187e63c096d35db92f1"
//         );
//         const data = response.data.tx;

//         // Filter out coinbase transaction
//         const filteredData = data.filter((tx) => !tx.is_coinbase);

//         // Get first 10 transactions
//         const top10Transactions = filteredData.slice(0, 10);
...
//   return (
//     <div>
//       <h2>10 Remarkable Bitcoin Transactions</h2>
//       <ul>
//         {transactions.map((tx) => (
//           <li key={tx.txid}>
//             {tx.txid}
...
// export default RemarkableTransactions;
